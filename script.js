...
// ====================
const revealElements = document.querySelectorAll('.skill-item, .project-card, .about-content, .experience-item, .education-item, .certification-item, .volunteering-item, .contact-content');
